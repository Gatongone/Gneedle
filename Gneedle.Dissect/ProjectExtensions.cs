...
{
    public static bool VerifyDissectDisable(this ProjectRootElement project) => project.TryGetProperty(TaskConstants.TOGGLE, out var property) && property!.Value == "disable";
