...
/// <summary>
/// Add <see cref="AssemblyInject"/> task to PostBuildEvent when the project use ProjectReference item to refer Gneedle.Dissect project with solution.
/// </summary>
public class AddProjectsPostBuild : Microsoft.Build.Utilities.Task
{
    /// <summary>
    /// Gneedle.Dissect name.
    /// </summary>
    public string ProjectName { get; private set; }

    /// <summary>
    /// Path of the solution that manages Gneedle.Dissect.csproj.
    /// </summary>
    public string SolutionPath { get; private set; }

    /// <summary>
    /// Gneedle.Dissect.dll path.
    /// </summary>
    ...
    private bool VerifyProject(ProjectRootElement project) => project.ContainsReference(ProjectName) && !project.VerifyDissectDisable();
