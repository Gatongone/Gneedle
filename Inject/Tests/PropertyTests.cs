...
public class PropertyTests
{
    ...
    /// <summary>
    /// Add a property to the host with the accessors which are asked for, which are written by hand rather than
    /// described through the chain.
    /// </summary>
    ...
    #region What the handler hands back
