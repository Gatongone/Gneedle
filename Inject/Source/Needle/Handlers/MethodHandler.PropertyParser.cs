...
partial class MethodHandler
{
    ...
    private void ParseProperty(string memberName, MemberSymbols memberSymbol, int currentIndex, InstructionFilter filter, MethodDefinition targetDef)
    {
        ...
        // placeholder is stands ahead of the name, and the type of that value is the type which the property is looked
        // up on. A value of a token is one of those - the instance which the member being woven belongs to, or another
