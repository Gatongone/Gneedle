...
public class MethodTests
{
    ...
    {
        var host = NewClass();
        var method = host.AddMethod("Foo", typeof(void).ToGneedleType(), [], [], MethodFlags.Public);
    ...
    public void AddMethod_WithParameters_Static()
    {
        ...
        var method = host.AddMethod(
            ...
            [],
            [typeof(string).ToGneedleType(), typeof(int).ToGneedleType()],
    ...
    public void AddMethod_InstanceCtor_Static_Throws()
    {
        ...
        Assert.Catch<ArgumentException>(() =>
            host.AddMethod(".ctor", typeof(void).ToGneedleType(), [], [], MethodFlags.Public | MethodFlags.Static));
    }
    ...
    public void AddMethod_InstanceCtor_Virtual_Throws()
    {
        var host = NewClass();
        Assert.Catch<ArgumentException>(() =>
            host.AddMethod(".ctor", typeof(void).ToGneedleType(), [], [], MethodFlags.Public | MethodFlags.Virtual));
    }
    ...
    public void AddMethod_StaticCtor_WithoutStatic_Throws()
    {
        var host = NewClass();
        Assert.Catch<ArgumentException>(() =>
            host.AddMethod(".cctor", typeof(void).ToGneedleType(), [], [], MethodFlags.Private));
    }
    ...
    public void AddMethod_StaticCtor_NonPrivate_Throws()
    {
        var host = NewClass();
        Assert.Catch<ArgumentException>(() =>
            host.AddMethod(".cctor", typeof(void).ToGneedleType(), [], [], MethodFlags.Static | MethodFlags.Internal));
    }
    ...
    {
        var host = NewClass();
        var method = host.AddMethod(".cctor", typeof(void).ToGneedleType(), [], [], MethodFlags.Static | MethodFlags.Private);
